...
@else
    @props(['comment'])
    <div class="flex flex-shrink-0 p-4 pb-0">
        <a href="{{ route('post.comments.store', $comment->user) }}" class="flex-shrink-0 group block">
            <div class="flex items-center">
                <div>
                    <img class="inline-block h-10 w-10 rounded-full"
    ...
    <div class="pl-16">
        ...
        <div class="flex">
            <div class="w-full">
                ...
                <div class="flex items-center">
                    <div class="flex-1 text-center">
                        <a href="{{ route('post.comments.show', $comment) }}"
                            class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
                    ...
                    <div
                        ...
                        @if (!auth()->user()->likes($comment->user))
                            {{-- @if (!$post->likes(auth()->user())) --}}
                            <form
                                class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300"
                                action="{{ route('posts.likes', $comment) }}" method="post" class="mr-1">
                                @csrf
                                <button type="submit"> <svg class="text-center h-6 w-6" fill="currentColor"
                                        stroke-linecap="round" viewBox="0 0 24 24">
                                        <g>
